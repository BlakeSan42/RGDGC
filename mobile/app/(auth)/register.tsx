...
export default function RegisterScreen() {
  ...
  useEffect(() => {
    if (google.idToken) {
      ...
      Alert.alert("Sign-Up Failed", google.error);
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.inner}>
        ...
        <Text style={styles.subtitle}>Create your account with Google — takes 5 seconds</Text>
        ...
        <Text style={styles.hint}>
          Your name, email, and photo are pulled from your Google account.{"\n"}
